...
class Wishlist extends React.Component {
    ...
    componentDidMount() {
        ...
        //let wishListArray = this.state.wishListArray
        let wishListArray = this.props.wishList
        let _self = this
     //   wishListArray.push(this.props.array)
    ...
    componentDidUpdate(prevProps, prevState) {
      ...
      /*  let ids =[]
        ...
        if(prevProps.update !==this.props.update){
            ...
            wishListArray.push(this.props.array)
            this.setState({wishListArray: wishListArray})
    ...
    deleteWishtList = (image) => {
       ...
       // })
      // this.setState({wishListArray: [ar]})
